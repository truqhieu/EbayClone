...
const { getSellerReputation } = require("../controllers/feedback.controller");
...
buyerRouter.get("/feedback/getPositiveReviews/:sellerId", getSellerReputation);
...
buyerRouter.get("/seller/profile/:sellerId", getSellerProfileBySellerId);
